...
{
    public class TvDbRequestBuilder
    {
        //private int _imdbId;
        ...
        //public TvDbRequestBuilder(string search,RequestBy requestBy,PlotType plotType = PlotType.Short, TypeOfSearch typeOfSearch = TypeOfSearch.Series,ReturnType returnformat = ReturnType.Json)
        //{
        //    switch (requestBy)
        //    {
        ...
        //public TvDbRequestBuilder(string search, int season, PlotType plotType = PlotType.Short, TypeOfSearch typeOfSearch = TypeOfSearch.Series, ReturnType returnformat = ReturnType.Json)
        //{
        //    RequestString = "i=" + search;
        //    Season = season;
        //    PlotType = plotType;
        ...
        //public TvDbRequestBuilder(string search, int season,int episode, PlotType plotType = PlotType.Short, TypeOfSearch typeOfSearch = TypeOfSearch.Series, ReturnType returnformat = ReturnType.Json)
        //{
        //    RequestString = "i=" + search;
        //    Season = season;
        //    Episode = episode;
